...
thisFile = "Assessments/CCGHighCholesterol.xml"
filepath = path.abspath(path.join(basepath, "..", "..", "..", thisFile))
fileNames = [[filepath, "CCG"]]

# ['../../../Assessments/CCGCAD.xml', 'CCG'],
# ['../../../Assessments/CCGComplexCaseManagement.xml, 'CCG'],
# ['../../../Assessments/CCGCOPD.xml', 'CCG'],
# ['../../../Assessments/CCGDiabetes.xml', 'CCG'],
# ['../../../Assessments/CCGHeartFailure.xml', 'CCG'],
# ['../../../Assessments/CCGHypertension.xml', 'CCG'], ['../../../Assessments/TransitionsOfCareCareCoordinationEvaluation.xml', 'TransitionsOfCare'], ['../../../Assessments/TransitionsOfCareOutpatientServices.xml', 'TransitionsOfCare'], ['../../../Assessments/TransitionsOfCareSkilledCareFacilityTransition.xml', 'TransitionsOfCare'], ['../../../Assessments/TransitionsOfCareTransitionCareAssessment.xml', 'TransitionsOfCare']]
