<script>
  ...
  $selectedProject = 'How We Gaze';
  let imgs = [
    '../assets/gaze/gaze-1.png',
    '../assets/gaze/gaze-2.png',
    '../assets/gaze/gaze-3.png',
    '../assets/gaze/kahlo2.png',
    '../assets/gaze/kahlo1.png',
  ];
...
<ProjectPage {imgs} {desc} {info} {link} />
