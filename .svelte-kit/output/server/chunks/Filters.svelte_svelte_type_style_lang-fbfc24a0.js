import { w as writable } from "./state-9669c413.js";
var Card_svelte_svelte_type_style_lang = "";
let projects = [
  {
    title: "Neuroengineering Thesis",
    description: "Undergrad thesis, simulating spinal cord simulation in primates",
    tags: ["product"],
    years: [2015],
    url: "/projects/thesis",
    protected: 0
  ...
  },
  {
    ...
    description: "Visualizing New York City housing through generative floor plans",
    tags: ["datavis"],
    years: [2020],
  ...
  {
    title: "How We Gaze",
    description: "Crowd-sourced meta-gallery showing how individuals look at artwork",
    tags: ["art", "datavis"],
    years: [2021],
    url: "/projects/gaze",
    protected: 0
  ...
  {
    title: "Tell Me",
    description: "A meditation on routine and structure, conveyed through the interface",
    tags: ["art"],
    years: [2021],
...
let projectData = writable(projectsSorted);
let projectsFiltered = writable(projectsSorted);
var Filters_svelte_svelte_type_style_lang = "";
export { projectsFiltered as a, projectData as p };
